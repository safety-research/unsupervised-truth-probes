...
def get_results_on_all_layers_dataset(
    dataset: CCSDataset,
    model_name: str,
    test_size: float = 0.5,
    seed: int = 42,
    ...
    all_cached = False #check_all_saved(dataset_name, model_name, layer_idx, run_methods)
    ...
    for layer_idx in tqdm(range(model.config.num_hidden_layers), desc="Layers"):
        ...
        layered_results[layer_idx] = results
